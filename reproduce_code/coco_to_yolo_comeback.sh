...
#เมื่อตอนสั่งดาวโโโหลดมา ให้มาลงหน้าบ้าน แต่นี่ย้ายมาวางในห้องเก็บของตั้งกะเมื่อไหร่
unzip 'train2014.zip' -d ../../heavystuffishere/coco/images/ &
inflate_pids+=("$!")
unzip 'val2014.zip' -d ../../heavystuffishere/coco/images/ &
inflate_pids+=("$!")
#unzip 'annotations_trainval2014.zip' -d ../heavystuffishere/coco/annotations/ & # Inflates to 'coco/annotations'.
