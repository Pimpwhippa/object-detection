...
###install Java in Dockerfile

wget https://download.java.net/java/GA/jdk13.0.2/d4173c853231432d94f001e99d882ca7/8/GPL/openjdk-13.0.2_linux-x64_bin.tar.gz
cd usr/lib
mkdir jvm
tar xfvz openjdk-13.0.2_linux-x64_bin.tar.gz --directory /usr/lib/jvm
apt update
update-alternatives --install /usr/bin/java java /usr/lib/jvm/ 1
